...
with tab1: 
    ...
    with col1:
        ...
        public_df = pd.read_csv("https://github.com/RichGHall/FRS_Model/files/Public_Av_Calls.csv")
        public_IAT = pd.read_csv("https://github.com/RichGHall/FRS_Model/files/Public_Av_Calls.csv")
